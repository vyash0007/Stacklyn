...
import { Users, Folder, Clock, UserCircle } from "lucide-react";
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto">
            ...
            <div className="mb-10">
                ...
                <p className="text-slate-500 mt-2 font-lg tracking-tight">
                    ...
                    {memberships.map((membership) => (
                        ...
                        >
                            <div className="relative z-10">
                                <div className="flex justify-between items-start mb-4">
                                    <div className="p-2.5 bg-slate-50 rounded-md group-hover:bg-slate-100 transition-professional">
            ...
            {/* Empty State */}
            {!isLoading && memberships.length === 0 && (
                <div className="text-center py-20 bg-white border-2 border-dashed border-slate-200 rounded-md shadow-sm">
                    <div className="w-16 h-16 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-4 border border-slate-100">
                        <Users className="h-8 w-8 text-slate-400" />
                    </div>
                    <h3 className="text-lg font-lg tracking-tight text-slate-900 mb-2">No team projects</h3>
                    <p className="text-slate-500 max-w-sm mx-auto font-lg tracking-tight">
