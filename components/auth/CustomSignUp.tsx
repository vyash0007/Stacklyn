        ...
        return (
            <div className="w-full max-w-sm mx-auto">
                ...
                <form onSubmit={handleVerify} className="space-y-8">
                    {error && (
                        <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-sm font-medium animate-fade-in">
                            {error}
                        </div>
                    )}
                    <div className="space-y-4">
                        <label className="text-xs font-bold text-zinc-500 ml-1 uppercase tracking-wider">Verification Code</label>
                        <input
                            type="text"
                            value={code}
                            onChange={(e) => setCode(e.target.value)}
                            placeholder="000000"
                            className="flex h-16 w-full rounded-xl border border-white/5 bg-black/40 px-4 py-2 text-center text-3xl font-bold tracking-[0.5em] text-white placeholder:text-zinc-800 placeholder:tracking-normal focus:outline-none focus:ring-1 focus:ring-white/10 focus:border-white/20 transition-all shadow-sm"
                            required
                        />
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-white hover:bg-zinc-200 text-black font-bold tracking-tight py-3.5 rounded-xl shadow-lg transition-all flex items-center justify-center group disabled:opacity-70"
                    >
        ...
        <div className="w-full max-w-sm mx-auto">
            ...
            <div className="relative mb-6 2xl:mb-8 w-full">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-[#181818] px-4 text-zinc-500 font-bold tracking-[0.2em]">OR SIGN UP WITH EMAIL</span>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3 2xl:space-y-4 w-full">
                ...
                <div className="grid grid-cols-2 gap-3 2xl:gap-4">
                    <div className="space-y-1 group text-left">
                        <label className="text-[11px] 2xl:text-xs font-bold text-zinc-500 ml-1 uppercase tracking-wider group-focus-within:text-white transition-colors">First Name</label>
                    ...
                    <div className="space-y-1 group text-left">
                        <label className="text-[11px] 2xl:text-xs font-bold text-zinc-500 ml-1 uppercase tracking-wider group-focus-within:text-white transition-colors">Last Name</label>
                        <div className="relative">
                            <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-zinc-500" />
                            <input
                                type="text"
            ...
            <p className="mt-6 2xl:mt-10 text-center text-zinc-500 font-medium tracking-tight">
                ...
                <Link href="/sign-in" className="text-white hover:text-zinc-300 font-bold decoration-dotted underline underline-offset-4 decoration-white/30">
                    Log in
                </Link>
            </p>
        </div>
