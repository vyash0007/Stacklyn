            ...
            <div className="hidden lg:flex lg:w-[55%] h-full bg-[#121212] relative flex-col items-center justify-center p-8 z-10 overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-2xl flex flex-col items-center">
                    ...
                    <div className="relative w-full h-[450px] lg:h-[480px] xl:h-[540px] flex items-center justify-center">
                        {/* Evaluation Card */}
                        <div className="absolute top-0 right-[5%] w-[320px] bg-[#1F1F1F]/60 backdrop-blur-xl rounded-[40px] shadow-[0_48px_96px_-24px_rgba(0,0,0,0.4)] p-10 z-30 border border-white/10">
                            <div className="flex justify-between items-center mb-8">
                                <div className="space-y-1.5 text-left">
                                    <div className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Platform</div>
                                    <div className="text-xl font-black text-white tracking-tight">Prompt Evaluation</div>
                                </div>
                                <div className="h-14 w-14 bg-white/5 rounded-[22px] border border-white/10 flex items-center justify-center">
                        ...
                        {/* Analytics Snapshot */}
                        <div className="absolute bottom-12 left-[4%] w-[300px] bg-[#1F1F1F]/60 backdrop-blur-xl rounded-[36px] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.3)] p-8 z-20 border border-white/10">
                            <div className="flex items-center justify-between mb-6">
                                <div className="h-10 w-10 bg-white/5 rounded-2xl border border-white/10 flex items-center justify-center">
