        ...
        <section className="relative pt-32 pb-20 overflow-hidden bg-white">
                ...
                <div className="lg:w-1/2 text-left z-10">
                    ...
                    <div className="flex items-center gap-4">
                        <Link
                            ...
                            className="px-8 py-3.5 bg-[#4F46E5] text-white rounded-lg text-lg font-lg tracking-tight hover:bg-[#4338CA] transition-all flex items-center group"
                        >
                            Start For Free
            ...
            <div className="mt-32 pt-20 border-t border-slate-50">
                <div className="max-w-7xl mx-auto px-6">
                    <p className="text-[11px] font-lg tracking-tight text-slate-400 uppercase tracking-[0.2em] mb-12 text-center lg:text-left">
                    ...
                    <div className="relative overflow-hidden group">
                        <div className="flex animate-scroll whitespace-nowrap gap-24 items-center">
                            {[...companies, ...companies].map((company, i) => (
                                <span
                                    key={i}
                                    className="text-2xl lg:text-3xl font-lg tracking-tight text-slate-300 transition-colors hover:text-slate-400 cursor-default"
                                >
                                    {company}
                                </span>
                            ))}
            ...
            < div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12 pt-32 pb-20" >
                {
                    [
                        ...
                        <div key={i} className="space-y-4">
                            ...
                            <h3 className="text-lg font-lg tracking-tight text-slate-900">{feature.title}</h3>
